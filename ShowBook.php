        ...
        <section class="best-seller-section">
            <div class="container">
                ...
                <div class="row">
                    <?php
                    include('CTD.php');
                    $query ="SELECT `book_id`, `book_name`, `book_image`, `book_descrption`, `book_pdf`, `book_price`, `departement_id`, `writers_id` FROM `book`";
                        ...
                        while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC))
                        {
                            ...
                            <div class="col-md-3 col-sm-6 wow fadeInDown animated" data-wow-delay="<?php echo $i; ?>s">
                                ...
                                <div class="text-center" style="margin-top:10px">
                                  <a href="deletebook.php?book_id=<?php echo $book_id ?>" type="button" class="btn btn-danger">Delete</a>
                                  <a href="updatebook.php?book_id=<?php echo $book_id; ?>" type="button" class="btn btn-info">Updete</a>  
                                </div>  
                                <?php
                                    }
                                    $i+=0.2;
